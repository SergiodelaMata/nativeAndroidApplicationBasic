...
public class Singleton {
    ...
    public static synchronized Singleton getInstance()
    {
        if(instance == null)
        {
            ...
            Subject subject1 = new Subject(1, 8.5, "Metodologías Ágiles", "2021-03-15");
            listSubjects.add(subject1);
            Subject subject2 = new Subject(2, 9, "Cloud Computing y Contenedores", "2021-03-13");
            listSubjects.add(subject2);
            Subject subject3 = new Subject(3, 9.4, "Integración Continua en el Desarrollo Ágil", "2021-03-12");
            listSubjects.add(subject3);
            Subject subject4 = new Subject(4, 9.2, "Frameworks Backend", "2021-03-10");
